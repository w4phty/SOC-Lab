...
def main():
    folder_linux = "shared-lab/SIEM-setup/sigma-rules/linux"
    folder_windows = "shared-lab/SIEM-setup/sigma-rules/windows"
    folder_network = "shared-lab/SIEM-setup/sigma-rules/network"
